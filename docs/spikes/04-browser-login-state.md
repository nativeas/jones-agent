...
1. **[已处理]** FR09 语义偏差未同 PR 更新 PRD/design、接口契约放错目录。已同 PR 更新 `docs/PRD.md` FR09 表述（8.1 表）与 12.3 验收口径；接口契约整段从本文件移到 `docs/design/00-foundation.md` §8，本文件只保留结论引用。
